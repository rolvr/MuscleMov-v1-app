...
class BluetoothManager2: NSObject, ObservableObject, CBCentralManagerDelegate, CBPeripheralDelegate {
    ...
    var body: some View {
        NavigationView {
            ...
            VStack {
                ...
                NavigationLink (
                    destination: MuscleSelectionView(),
                    isActive: $isActive
                ) {
                    EmptyView()
                }
...
struct RolBLE2_Previews: PreviewProvider {
